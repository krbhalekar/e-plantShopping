        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    {calculateTotalQuantity() > 0 && <span style={{ position: 'absolute', top: '10px', right: '10px', backgroundColor: '#ff6b6b', color: 'white', borderRadius: '50%', width: '28px', height: '28px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '14px', fontWeight: 'bold' }}>{calculateTotalQuantity()}</span>}
                    </div>
                </div>
            </div>
            {!showCart ? (
                                ...
                                {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                                    <div className="product-card" key={plantIndex}> {/* Unique key for each plant card */}
                                        ...
                                        <button
                                            ...
                                            style={{
                                              backgroundColor: isItemInCart(plant.name) ? '#cccccc' : '',
                                              color: isItemInCart(plant.name) ? '#666666' : '',
                                              cursor: isItemInCart(plant.name) ? 'not-allowed' : 'pointer',
                                              opacity: isItemInCart(plant.name) ? 0.6 : 1
                                            }}
                                        >
